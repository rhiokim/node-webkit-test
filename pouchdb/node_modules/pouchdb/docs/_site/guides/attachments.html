...
<p>PouchDB attachments allow you to use that to full advantage to store images, zip files, or whatever you want.</p>
...
<p>If you want to avoid working with base64-encoded strings, you can also use the <code>putAttachment()</code> API to directly store the binary data as a Blob. <code>putAttachment()</code> works the same as <code>put()</code>, except that it simply modifies the existing document to hold a new attachment.</p>
...
<span class="nx">convertImgToBlob</span><span class="p">(</span><span class="nx">catImage</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">blob</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">db</span><span class="p">.</span><span class="nx">put</span><span class="p">({</span><span class="nx">_id</span><span class="o">:</span> <span class="s1">&#39;meowth&#39;</span><span class="p">}).</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">()</span> <span class="p">{</span>
    <span class="k">return</span> <span class="nx">db</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;meowth&#39;</span><span class="p">);</span>
  <span class="p">}).</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">doc</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">return</span> <span class="nx">db</span><span class="p">.</span><span class="nx">putAttachment</span><span class="p">(</span><span class="s1">&#39;meowth&#39;</span><span class="p">,</span> <span class="s1">&#39;meowth.png&#39;</span><span class="p">,</span> <span class="nx">doc</span><span class="p">.</span><span class="nx">_rev</span><span class="p">,</span> <span class="nx">blob</span><span class="p">,</span> <span class="s1">&#39;image/png&#39;</span><span class="p">);</span>
  <span class="p">}).</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">()</span> <span class="p">{</span>
